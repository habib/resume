...
\item Own Cloud Operations for (almost) all tools \& services used to build \& operate the Firefox web browser on popular operating systems and platforms
\item Manage a globally distributed DevOps team that supports 20 unique Engineering teams
  \item These 52 services span various domains; large scale user facing services (such as \href{https://github.com/mozilla-services/syncstorage-rs}{Sync}, \href{https://github.com/mozilla-services/autopush-rs}{Push}, \href{https://github.com/mozilla/fxa}{Accounts}, \href{https://github.com/mozilla/addons}{Addons} etc) to developer focused services (like \href{https://github.com/taskcluster}{TaskCluster})
  \item Some notable highlights include:
  \vspace{-0.5em}
  \begin{itemize}  \itemsep0.5pt \parskip0pt
    \item[$\cdot$] Planning \& executing multi-year cloud migrations while also modernizing operational tooling
    ...
    \item[$\cdot$] Investing in tooling to audit state of cloud infrastructure along cost \& availability factors
    \item[$\cdot$] Removing technical \& cultural barriers to safely, \& bravely, continuously deploy services

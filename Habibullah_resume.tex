...
\item Focused on driving efficiencies in Engineering activities, such as, but not limited to:
  \vspace{-0.5em}
\begin{itemize}  \itemsep0.5pt \parskip0pt
    ...
    \item[$\cdot$] Creating quick \& repeatable processes to apply fixes for CVEs
    \item[$\cdot$] Upgrading compute and network virtualization infrastructure, crucial parts that power Cloud Servers
\end{itemize}
...
\item Identified ways to quickly improve newly rebuilt teams' domain knowledge \& reduced ramp-up time
...
\item Increased stakeholders' confidence in automation of testing by boosting coverage, effectiveness \& reliability thereby gradually eliminating need/requests for manual testing

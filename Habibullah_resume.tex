...
\item Launched new services like \href{https://monitor.firefox.com/}{Monitor}, \href{https://relay.firefox.com/}{Relay} \& \href{https://vpn.mozilla.org/}{VPN} that unlock monetization opportunities. Launched \href{https://blog.mozilla.org/security/2020/01/21/crlite-part-3-speeding-up-secure-browsing/}{CRLite} that greatly reduces Firefox's page load time on secure websites
  ...
  \vspace{-0.5em}
    ...
    \item[$\cdot$] Standardizing service component nomenclature \& partnering with the data team to visualize service costs across multiple dimensions
  ...
  \item Improving the team's ability to scale up by:
     \vspace{-0.5em}
    \begin{itemize} \itemsep0.5pt \parskip0pt 
  \item[$\cdot$] Modernizing operational tooling: Puppet \& CloudFormation to Terraform
...
{Quality Engineering Manager of 14 Quality Engineers}
  \item Managed 3 mixed feature teams of Rackers \& contractors tasked with testing different components of Rackspace's in-house Billing system
...
\item Identified ways to increase newly rebuilt teams' domain knowledge \& reduced ramp-up time to days
...
\item Built a Rails app on Heroku that let users donate text messaging credits to their choice of non-profits

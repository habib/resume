...
\item Manage a globally distributed DevOps team that supports 20 unique Engineering teams
  \item These 52 services span various domains; large scale user facing services (such as Sync, Push, Accounts, Addons etc) to developer focused services (like TaskCluster)
